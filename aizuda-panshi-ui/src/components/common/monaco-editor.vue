...
const value = defineModel<any>('modelValue', { required: true, default: '' });
...
<template>
  <NCard
    ...
    @click="() => (isActive = true)"
    @mouseout.passive="() => (isActive = false)"
  >
    <div ref="editContainer" class="sa-code-editor" :style="{ height: height }" />
  </NCard>
</template>
