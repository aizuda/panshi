...
declare module "@elegant-router/types" {
  ...
  export type RouteMap = {
    ...
    "about": "/about";
    "gen": "/gen";
    "gen_database": "/gen/database";
    "gen_template": "/gen/template";
    "home": "/home";
    "iframe-page": "/iframe-page/:url";
    "login": "/login/:module(pwd-login|reset-pwd|code-login)?";
    "setting": "/setting";
    "setting_app": "/setting/app";
    "setting_configure": "/setting/configure";
    "setting_department": "/setting/department";
    "setting_dict": "/setting/dict";
    "setting_menu": "/setting/menu";
    "setting_post": "/setting/post";
    "setting_region": "/setting/region";
