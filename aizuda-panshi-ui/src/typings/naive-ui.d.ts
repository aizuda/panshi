declare namespace NaiveUI {
  ...
  type TableApiTreeFn<T = any, R = Record<string, any>> = (params: R) => Promise<FlatResponseData<T[]>>;
  ...
  type GetTreeTableData<A extends TableApiTreeFn> = A extends TableApiTreeFn<infer T> ? T : never;

  type NaiveTreeTableConfig<A extends TableApiTreeFn> = Pick<
