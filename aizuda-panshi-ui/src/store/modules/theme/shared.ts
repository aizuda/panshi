 ...
 * @param [recommended=false] Use recommended color. Default is `false`
 */
export function getDarkTheme(colors: App.Theme.ThemeColor, recommended = false) {
  const theme: GlobalThemeOverrides = {
    ...getNaiveTheme(colors, recommended),
    Button: {
      textColorPrimary: 'rgba(255, 255, 255, 0.82)',
      textColorError: 'rgba(255, 255, 255, 0.82)',
      textColorWarning: 'rgba(255, 255, 255, 0.82)'
    }
  };
