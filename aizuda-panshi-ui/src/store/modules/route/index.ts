...
export const useRouteStore = defineStore(SetupStoreId.Route, () => {
  ...
  function parseRouter(route: ElegantConstRoute, parent?: ElegantConstRoute) {
    if (authRouteMode.value === 'dynamic') {
      ...
      route.name = parent ? `${parent.name}_${route.name}` : route.name;
      ...
      route.meta!.hideInMenu = Boolean(route.meta?.hidden) || false;
      ...
      if (type === 'iframe') {
        ...
        route.meta!.href = String(route.redirect);
        route.redirect = undefined;
      }
    }
  ...
  async function initConstantRoute() {
    ...
    if (authRouteMode.value === 'static') {
      ...
      const dynamicRoutes = createDynamicRoutes();
      addConstantRoutes(dynamicRoutes.constantRoutes);
    }
